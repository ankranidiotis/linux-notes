...
3. Οι φάκελοι βιβλιοθήκης πρέπει να έχουν τα κατάλληλα δικαιώματα πρόσβασης από τον Plex Server. Για αυτό τον λόγο τρέχουμε για κάθε φάκελο την εντολή `sudo chmod -R 755 /διαδρομή/προς/τα/αρχεία/σου`.
